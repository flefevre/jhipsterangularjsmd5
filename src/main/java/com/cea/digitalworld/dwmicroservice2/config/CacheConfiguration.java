package com.cea.digitalworld.dwmicroservice2.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.cea.digitalworld.dwmicroservice2.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.cea.digitalworld.dwmicroservice2.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
